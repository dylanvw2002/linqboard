        ...
        <section className="container mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="relative scale-105 sm:scale-110">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 sm:-top-6 -left-4 sm:-left-6 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-primary to-accent rounded-full opacity-20 blur-2xl"></div>
            </div>
